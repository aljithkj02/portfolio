        ...
        <div className="flex flex-col md:flex-row items-center justify-between gap-8">
          ...
          >
            <h1 className="text-3xl sm:text-4xl md:text-5xl lg:text-6xl font-bold mb-4">
              Hi, I'm <span className="text-blue-300">Aljith K J</span>
            </h1>
            ...
            <p className="text-base sm:text-lg md:text-xl text-blue-100 mb-8 max-w-lg mx-auto md:mx-0">
              I turn complex ideas into simple, efficient applications. Specializing in web development and DevOps with a passion for blockchain technology.
            </p>
